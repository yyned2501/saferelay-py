...
modules = [
    ...
    ('services.forward_topic', 'from services.forward_topic import ForwardTopicService'),
    ('services.forward_edit', 'from services.forward_edit import ...'),
    ...
    ('services.menu', 'from services.menu import ...'),
    ('utils.helpers', 'from utils.helpers import ...'),
